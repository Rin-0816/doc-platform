...
- カテゴリ、レッスン、タグの list/create API と作成ツール内の編集 UI
- 文書一覧の分類/単元/タグ絞り込み、並び替え、分類表示
- 文書検索の分類、単元、タグ絞り込みと用語検索
...
1. 用語の作成/編集 API と関連文書リンク
2. 認証 provider / 検索 provider の実 runtime 対応
3. Chrome 以外のブラウザ確認
4. バックアップ自動化と運用 tooling
