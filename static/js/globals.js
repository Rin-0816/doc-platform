...
const translations = {
  en: {
    ...
    slug_help_auto: "Leave blank to auto-generate from the title.",
    slug_auto_placeholder: "Auto-generated from the title",
    summary: "Summary",
    category: "Category",
    lesson: "Lesson",
    tags: "Tags",
    ...
    initial_version_no_compare: "Initial version — nothing to compare.",
    revision: "Revision",
    against: "Against",
    compare: "Compare",
    restore: "Restore",
    ...
    attachments_empty_hint: "Save the document, then upload images to manage them here.",
    attachments_none: "No attachments yet.",
    loading_attachments: "Loading attachments...",
    delete_attachment: "Delete",
    delete_attachment_aria: "Delete attachment {name}",
    delete_attachment_confirm: "Delete this attachment? Its file will be removed from the server. This cannot be undone.",
    delete_attachment_in_use_confirm: "This image is still referenced in the document. Deleting it will break that reference and remove the file from the server. Delete anyway?",
    ...
    comment_action_cancel: "Cancel",
    comment_anchor_marker: "View comment anchored here",
    ...
    no_changes: "No changes between these versions.",
    ...
    export: "Export",
    export_document: "Export this document",
    import_document: "Import a document",
    document_exported: "Document exported.",
    importing_document: "Importing document...",
    document_imported: "Document imported.",
    document_imported_skipped: "Document imported. {count} non-image attachment(s) skipped.",
    import_invalid_file: "That file is not a valid document export.",
    ...
    lessons: "Lessons",
    rename: "Rename",
    taxonomy_usage: "{count} use(s)",
    taxonomy_empty: "None yet.",
    taxonomy_name_required: "Name is required.",
    taxonomy_loading: "Loading...",
    taxonomy_deleting: "Deleting...",
    delete_taxonomy_confirm: "Delete this item? It will be removed from {count} document(s). This cannot be undone.",
    delete_tag_confirm: "Delete this tag? It will be removed from {count} document(s)/term(s). This cannot be undone.",
  },
  ja: {
    app_title: "文書管理",
    docs_short: "文書",
    ...
    slug_help_auto: "空欄のままにするとタイトルから自動生成します。",
    slug_auto_placeholder: "タイトルから自動生成します",
    summary: "概要",
    category: "分類",
    lesson: "単元",
    tags: "タグ",
    ...
    revision_diff: "改訂差分",
    revision_timeline: "改訂タイムライン",
    current_revision: "現在",
    advanced_compare: "詳細比較",
    initial_version_no_compare: "初版のため比較対象がありません。",
    revision: "改訂",
    against: "比較対象",
    compare: "比較",
    restore: "復元",
    ...
    attachments: "添付ファイル",
    attachments_empty_hint: "文書を保存すると、アップロードした画像をここで管理できます。",
    attachments_none: "添付ファイルはまだありません。",
    loading_attachments: "添付ファイルを読み込み中...",
    delete_attachment: "削除",
    delete_attachment_aria: "添付ファイル {name} を削除",
    delete_attachment_confirm: "この添付ファイルを削除しますか？サーバーからファイルが削除されます。この操作は取り消せません。",
    delete_attachment_in_use_confirm: "この画像はまだ文書内で参照されています。削除すると参照が壊れ、サーバーからファイルが削除されます。それでも削除しますか？",
    ...
    comment_action_save: "保存",
    comment_action_cancel: "キャンセル",
    comment_anchor_marker: "ここに紐づくコメントを表示",
    ...
    no_changes: "これらのバージョン間に変更はありません。",
    ...
    export: "エクスポート",
    export_document: "この文書をエクスポート",
    import_document: "文書をインポート",
    document_exported: "文書をエクスポートしました。",
    importing_document: "文書をインポート中...",
    document_imported: "文書をインポートしました。",
    document_imported_skipped: "文書をインポートしました。画像以外の添付ファイル {count} 件をスキップしました。",
    import_invalid_file: "このファイルは有効な文書エクスポートではありません。",
    settings_autolink_on: "オン",
    settings_autolink_off: "オフ",
    refresh_plugins: "更新",
    manage_taxonomy: "分類の管理",
    categories: "カテゴリ",
    lessons: "レッスン",
    rename: "名前を変更",
    taxonomy_usage: "{count} 件で使用",
    taxonomy_empty: "まだありません。",
    taxonomy_name_required: "名前は必須です。",
    taxonomy_loading: "読み込み中...",
    taxonomy_deleting: "削除中...",
    delete_taxonomy_confirm: "この項目を削除しますか？{count} 件の文書から解除されます。この操作は元に戻せません。",
    delete_tag_confirm: "このタグを削除しますか？{count} 件の文書・用語から解除されます。この操作は元に戻せません。",
  },
};
...
const elements = {
  ...
  attachmentManagerGroup: document.querySelector("#attachment-manager-group"),
  attachmentList: document.querySelector("#attachment-list"),
  attachmentListEmpty: document.querySelector("#attachment-list-empty"),
